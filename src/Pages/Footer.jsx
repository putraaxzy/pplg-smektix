          ...
          <div class="grid grid-cols-2 sm:grid-cols-3">
            <div className=" ">
              ...
              <ul class="text-gray-400 dark:text-gray-400 font-medium">
                <li class="mb-2">
                  <a
                    href="https://www.instagram.com/muzakie624/?hl=id"
                ...
                <li class="mb-2">
                  <a
                    href="https://www.instagram.com/onlyptraa"
                    class="hover:underline"
                  >
                    PUTRA
                  </a>
                ...
                <li class="mb-2">
                  <a
                    href="https://www.instagram.com/prim.m.t"
                    class="hover:underline"
                  >
                    PRIMA
                  </a>
            ...
            <div className="">
              ...
              <ul class="text-gray-400 dark:text-gray-400 font-medium">
                <li class="mb-2">
                  <a
                    href="https://www.instagram.com/smektix_xpplg/?hl=id"
                    class="hover:underline "
                  >
                    Instagram
                  </a>
                ...
                <li class="mb-2">
                  <a
                    href="https://github.com/ganesha-smektix"
                    class="hover:underline "
                  >
                    Github
                  </a>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <div class="flex mt-4 justify-center sm:mt-0">
            <p className="text-[0.7rem] text-white opacity-70">
              © {new Date().getFullYear()} Kelas X PPLG | Di Kelola Oleh Siswa X
              PPLG
            </p>
          </div>
        </div>

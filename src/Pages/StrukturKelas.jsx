	...
	return (
		<div className="z-1  relative h-auto lg:h-[83vh] lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Agus Sutrasno S.Pd" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div
					...
					<div className="flex-col">
						...
						<BorderStruktur Jabatan="" Nama="Winni" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Lilis" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Dina" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex justify-center items-center flex-col">
						...
						<div className="relative bottom-3">
							...
							<BorderStruktur Jabatan="Siswa" Nama="X PPLG" Width="120px" />
							<div className="py-[3%]"></div>
						</div>
					</div>
				</div>
